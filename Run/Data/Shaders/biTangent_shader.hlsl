...
v2f_t VertexFunction(vs_input_t input)
{
   ...
   float4 biTangents = mul( MODEL, float4(input.biTangent, 0.f));

   v2f.color.x = RangeMap(biTangents.x, -1.0f, 1.0f, 0.0f, 1.0f);
   v2f.color.y = RangeMap(biTangents.y, -1.0f, 1.0f, 0.0f, 1.0f);
   v2f.color.z = RangeMap(biTangents.z, -1.0f, 1.0f, 0.0f, 1.0f);
   v2f.color.w = 1.0f;
